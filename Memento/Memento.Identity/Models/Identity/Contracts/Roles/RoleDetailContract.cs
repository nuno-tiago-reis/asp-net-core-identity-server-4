...
{
	/// <summary>
	/// Implements the 'RoleDetail' contract.
	/// </summary>
	[SuppressMessage("ReSharper", "UnusedMember.Global")]
	public sealed class RoleDetailContract
	{
		#region [Properties]
		/// <summary>
		...
		public List<RoleClaimDetailContract> Claims { get; set; }

		/// <summary>
		/// The Role's users.
		/// </summary>
		[Display(Name = nameof(SharedResources.ROLE_ROLEUSERS), ResourceType = typeof(SharedResources))]
		public List<RoleUserDetailContract> Users { get; set; }
