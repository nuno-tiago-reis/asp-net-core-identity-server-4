...
{
	/// <summary>
	/// Implements the 'UserList' contract.
	/// </summary>
	[SuppressMessage("ReSharper", "UnusedMember.Global")]
	public sealed class UserListContract
	{
		#region [Properties]
		/// <summary>
		...
		public ICollection<UserClaimListContract> Claims { get; set; }

		/// <summary>
		/// The User's roles.
		/// </summary>
		[Display(Name = nameof(SharedResources.USER_USERROLES), ResourceType = typeof(SharedResources))]
		public ICollection<UserRoleListContract> Roles { get; set; }
